...
class InceptionCateModule:

    def __init__(self, architecture='inception_v3',
                 eval_step_interval=10, final_tensor_name='final_result', flip_left_right=False,
                 how_many_training_steps=4000, image_dir='',
                 intermediate_store_frequency=0, learning_rate=0.8, model_dir='./inception_cate/imagenet',
                 output_labels='./inception_cate/output_labels.txt', print_misclassified_test_images=False, random_brightness=0,
                 random_crop=0, random_scale=0, test_batch_size=-1,
                 train_batch_size=50, validation_batch_size=100, check_point_path='./inception_cate/checkpoint', main_path='./inception_cate'):
